  ...
  return (
    <>
     <header className="flex bg-black h-14 items-center justify-between ">
        <Link className="text-white text-xl m-10 font-serif">peerspace</Link>
        <Searchbar/>
        <div className="m-5">
            ...
            <button className="bg-pink-600 text-[#fefefe] font-serif text-xl rounded-[5px] w-20 p-1" onClick={()=>setModal(true)}>Register</button>
        </div>
     </header> 
    {/*registration modal */}
